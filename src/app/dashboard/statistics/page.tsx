...
import { getTop10Products, getWarehouses, getLocations, searchProducts, type Top10ProductsParams } from '@/lib/api';
...
export default function StatisticsPage() {
    ...
    const fetchAllData = useCallback(async () => {
        ...
        try {
            ...
            const totalValue = searchData.reduce((sum, p) => sum + p.price * p.quantity, 0);
            const avgPrice = totalProducts > 0 ? totalValue / totalProducts : 0;
            const lowStock = searchData.filter((p) => p.quantity < 10).length;
