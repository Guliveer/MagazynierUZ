...
import { SearchHistory } from "@/components/products/SearchHistory";
...
export default function ProductsPage() {
  ...
  // Search history
  const { history, isLoading: isHistoryLoading, addSearch, removeSearch, clearHistory } = useSearchHistory();
